package club.frozed.frozedteams.utils.configurations;
...
public class ConfigFile {
    ...
    public ConfigFile(String name) {
        this.name = name;
        this.file = new File(FrozedTeams.getInstance().getDataFolder(), name + ".yml");
        if (!this.file.exists()) {
            FrozedTeams.getInstance().saveResource(name + ".yml", false);
        }
